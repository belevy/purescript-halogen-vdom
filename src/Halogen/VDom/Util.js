...
exports.createSubScreen = function (fnObject, machine, screen) {
  return {type: "SubScreen", children: [], props: {}, __ref: fnObject.createPrestoElement(), machine : machine, screen : screen};
};
